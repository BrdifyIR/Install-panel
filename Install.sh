...
install_pasarguard() {
    ...
    echo "  10) Install Recommended Node"
    echo "  11) Install Multiple Nodes (node-eu-1)"
    echo "  12) Update Panel"
    echo "  13) Update Node"
    echo "  0) Back to Main Menu"
    echo "========================================="
    echo ""
    read -p "Please select an option [0-13]: " db_choice
    ...
    case $db_choice in
        ...
        10)
            echo ""
            print_info "Installing Recommended Node..."
        ...
        11)
            echo ""
            print_info "Installing Multiple Nodes (node-eu-1)..."
        ...
        12)
            echo ""
            print_info "Updating Pasarguard Panel..."
            pasarguard update
            echo ""
            read -p "Press Enter to return to menu..."
            install_pasarguard
        ...
        13)
            echo ""
            print_info "Updating Pasarguard Node..."
            pg-node update
            echo ""
            read -p "Press Enter to return to menu..."
            install_pasarguard
